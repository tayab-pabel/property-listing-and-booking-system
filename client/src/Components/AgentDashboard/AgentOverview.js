import { CheckCircleIcon, ClockIcon, CurrencyBangladeshiIcon, FireIcon, HomeIcon, LocationMarkerIcon, OfficeBuildingIcon, ScaleIcon } from '@heroicons/react/outline';
    ...
    <div>
      ...
      <div className="xl:flex xl:items-center xl:justify-between">
        ...
        <div className="mt-4 flex space-x-3 xl:mt-0 xl:ml-4">
          ...
          <button
            type="button"
            className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-blue-light"
          >
            Add Branch
          </button>
        </div>
      ...
      <div className="mt-5">
      <h2 className="text-lg leading-6 font-medium text-blue-dark">Property overview for sale</h2>
        <div className="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <HomeIcon className="h-6 w-6 text-blue-dark" aria-hidden="true" />
                </div>
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-blue-dark truncate">Number of property</dt>
                    <dd>
                      <div className="text-lg font-medium text-blue-light">{agent.property[0].totalProperty}</div>
                    </dd>
                  </dl>
                </div>
              </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <CurrencyBangladeshiIcon className="h-6 w-6 text-blue-dark" aria-hidden="true" />
                </div>
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-blue-dark truncate">Avg. asking price</dt>
                    <dd>
                      <div className="text-lg font-medium text-blue-light">{agent.property[0].avgAskingPrice}</div>
                    </dd>
                  </dl>
                </div>
              </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <ClockIcon className="h-6 w-6 text-blue-dark" aria-hidden="true" />
                </div>
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-blue-dark truncate">Avg. listing time</dt>
                    <dd>
                      <div className="text-lg font-medium text-blue-light">{agent.property[0].avgListingTime} weeks</div>
                    </dd>
                  </dl>
                </div>
              </div>
      ...
      <div className="mt-5">
      <h2 className="text-lg leading-6 font-medium text-blue-dark">Property overview for rent</h2>
        <div className="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-blue-dark truncate">Number of property</dt>
                    <dd>
                      <div className="text-lg font-medium text-blue-light">{agent.property[1].totalProperty}</div>
                    </dd>
                  </dl>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-blue-dark truncate">Avg. asking price</dt>
                    <dd>
                      <div className="text-lg font-medium text-blue-light">{agent.property[1].avgAskingPrice}</div>
                    </dd>
                  </dl>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-blue-dark truncate">Avg. listing time</dt>
                    <dd>
                      <div className="text-lg font-medium text-blue-light">{agent.property[1].avgListingTime} weeks</div>
                    </dd>
                  </dl>
                </div>
              </div>
