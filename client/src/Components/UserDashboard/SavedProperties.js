                ...
                <div className="">
                  ...
                  <div className='flex'>
                    <div className='flex flex-wrap content-center h-8'>
                      ...
                      <p className='text-sm text-blue-dark ml-1 font-medium'>{savedProperty.beds} Beds</p>
                    </div>
                    <div className='flex flex-wrap content-center ml-3 h-8'>
                      ...
                      <p className='text-sm text-blue-dark ml-1 font-medium'>{savedProperty.beds} Baths</p>
                    </div>
                    <div className='flex flex-wrap content-center ml-3 h-8'>
                      <span className=''>
                      ...
                      <p className='text-sm text-blue-dark ml-1 font-medium'>{savedProperty.size} Sqft</p>
                    </div>
                  </div>
