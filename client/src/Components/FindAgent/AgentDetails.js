              ...
              <div className="lg:grid lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gap-x-10">
                ...
                <div className="lg:col-span-4">
                  ...
                  <div className="mt-2">
                    ...
                    <div className="mt-3">
                      <h3 className="text-sm font-bold text-blue-dark">Follow on</h3>
                      <ul role="list" className="flex items-center space-x-3 mt-2">
                        <li>
                          <a href="#" className="flex items-center justify-center w-6 h-6 text-blue-dark hover:text-blue-light">
                  ...
                  <Tab.Group as="div">
                    ...
                    <Tab.Panels as={Fragment}>
                      <Tab.Panel className="mt-5">
                        ...
                        <p className="text-sm text-blue-dark">{agent.overview}</p>
                                  ...
                                  <tbody>
                                    {agent.property.map((property, propertyIdx) => (
                                      <tr key={property.email} className={propertyIdx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                                        ...
                                        <td className="p-3 text-xs font-medium text-center text-blue-dark">{property.avgListingTime}</td>
                                      </tr>
                                    ))}
                                  </tbody>
                                </table>
                        ...
                        <div className="mt-5">
                          ...
                          <div className="mt-1 shadow rounded-lg border border-blue-dark">
                            <ul role="list" className="divide-y divide-blue-dark">
                                    ...
                                    <div className="p-4">
                                      <div className="sm:flex items-center">
                                        ...
                                        <div className="sm:ml-3 mt-3 sm:mt-0">
                                          <p className="text-lg font-bold text-blue-dark">{property.price} BDT</p>
                                          <p className="text-base font-medium text-blue-dark truncate">{property.address.location}, {property.address.city}, {property.address.postalCode}</p>
                                          <p className="text-sm font-medium text-blue-dark truncate">{property.name}</p>
                                          <p className="text-xs font-medium text-blue-dark truncate">{property.beds} Beds, {property.baths} Bats, {property.size} Sqft</p>
                                        </div>
                                      </div>
                                    </div>
                                  </a>
                            ...
                            {agent.about.teamMembers.map((member) => (
                              ...
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  <p className="text-sm font-bold text-blue-dark">{member.name}</p>
                                  <p className="text-xs text-blue-light truncate">{member.designation}</p>
                                </div>
                              </div>
                            ))}
                          </div>
