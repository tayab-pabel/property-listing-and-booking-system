        ...
        <div className="lg:grid lg:grid-cols-2 rounded-lg border border-blue-dark z-10 cursor-pointer">
          ...
          <div className='p-5'>
            ...
            <div className='mt-2'>
              ...
              >
                <PhoneIcon className="-ml-0.5 mr-1.5 w-5 h-5 text-blue-light" aria-hidden="true" />
                Call
              </button>
              <button
                type="button"
              ...
              >
                <MailIcon className="-ml-0.5 mr-1.5 w-5 h-5 text-blue-light" aria-hidden="true" />
                Email
              </button>
              <button
                type="button"
                className="inline-flex items-center px-3 py-2 border border-blue-dark shadow-sm text-sm leading-4 font-medium rounded-lg text-blue-dark bg-white ml-3"
              >
                <HeartIcon className="-ml-0.5 mr-1.5 w-5 h-5 text-blue-light" aria-hidden="true" />
                Save
              </button>
            </div>
