...
import { ArrowLeftIcon, CheckCircleIcon, CheckIcon, HeartIcon, PhoneIcon, ShareIcon } from '@heroicons/react/outline';
          ...
          <div className="bg-white rounded-lg shadow py-6 px-4 sm:py-10 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="lg:grid lg:grid-cols-12 lg:gap-x-6 lg:gap-y-10 xl:gap-x-8">
              <div className="lg:col-span-8">
                ...
                <div className='mt-10'>
                  <h3 className='text-lg text-blue-dark font-bold'>Floor Plan</h3>
                  <div>
                    <div 
                      onClick={openModal}
                ...
                <div className='mt-10'>
                  <h3 className='text-lg text-blue-dark font-bold'>Description</h3>
                  <p className='text-base text-justify text-blue-dark mt-3'>
                    {property[0].descriptions}
                  </p>
                </div>
