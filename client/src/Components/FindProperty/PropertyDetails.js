  ...
  const property = [
    {
      ...
      imageGallery: [
        ...
        {
          original:
            'https://lid.zoocdn.com/u/1600/1200/add9afffa1283af1895050b8ab2e7b18d0f92c25.jpg:p',
          thumbnail:
            'https://lid.zoocdn.com/u/1600/1200/add9afffa1283af1895050b8ab2e7b18d0f92c25.jpg:p',
        },
        {
              ...
              <div className='lg:col-span-8'>
                ...
                <div>
                  ...
                  <p className='text-base text-blue-dark'>
                    {property[0].address.location}, {property[0].address.city} -{' '}
                    {property[0].address.postalCode}
                  </p>
                  <div className='flex'>
                ...
                <div className='mt-10'>
                  ...
                  <div className='grid grid-cols-2 text-base text-blue-dark mt-3'>
                    {property[0].featuresAndAmenities.map((feature, index) => (
                      <div className='flex text-base items-center' key={index}>
