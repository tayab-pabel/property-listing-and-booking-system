...
const Footer = () => {
    ...
    const navigation = {
        ...
        quickLinks: [
            ...
            { name: 'Sign Up / Log In', href: '#' },
            { name: 'Create Agent Account', href: '#' },
            { name: 'Mortgage', href: '#' },
        ],
        about: [
            { name: 'About Us', href: '#' },
    ...
    return (
        <footer className="bg-white pt-20 pb-10" aria-labelledby="footer-heading">
            ...
            <div className="max-w-full mx-auto px-4 py-3 sm:px-6 lg:justify-start">
                    ...
                    <div className="space-y-8 xl:col-span-1">
                        ...
                        <div className="flex space-x-6">
                            {navigation.social.map((item) => (
                                <a key={item.name} href={item.href} className="text-blue-dark hover:text-blue-light">
