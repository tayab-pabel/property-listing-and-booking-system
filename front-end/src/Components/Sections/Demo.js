                  ...
                  <div className='flex-auto'>
                    ...
                    <Popover className='relative'>
                      {({ open }) => (
                        <>
                          <Popover.Button>
                            <button className='bg-white mt-1 py-2 pl-4 pr-6 text-base border border-blue-dark focus:outline-none focus:ring-blue-light active:ring-blue-light focus:border-blue-light text-blue-dark sm:text-sm rounded-lg flex items-center capitalize'>
                              {propertyType}
                                            ...
                                            <div key={propertType.id}>
                                              <div className='relative flex items-start py-0.5'>
                                                ...
                                                <div className='ml-3 text-sm'>
                                                  <label
                                                    htmlFor={propertType.title}
                                                    className='text-sm font-medium text-blue-dark'
                                                  >
                                                    {propertType.title}
                                                  </label>
                                                </div>
