...
const FindAgentSearchFilter = () => {
  return (
    <div className="bg-gray-100">
      <div className="max-w-4xl mx-auto px-4 py-5 sm:py-10">
        <h2 className="text-3xl leading-6 font-medium text-blue-dark">Find an Agent</h2>
        <form className="mt-5 sm:flex sm:items-center">
          ...
          <div className="w-full sm:mt-0 sm:ml-3">
            <label 
              htmlFor="name" 
              className="block text-left text-sm font-medium text-blue-dark"
            >
          ...
          <button
            type="submit"
            className="mt-6 w-full inline-flex items-center justify-center px-4 py-2 border border-transparent shadow-sm font-medium rounded-lg text-white bg-blue-light sm:ml-3 sm:w-auto sm:text-sm"
          >
            Search
          </button>
        </form>
